...
#@ (init_flow): read_flow /nethome/dkhalil8/InnovateECE/PhysicalDesign/design/scripts/flow.yaml
#@ (init_flow): cd /nethome/dkhalil8/InnovateECE/PhysicalDesign/design
#@ (init_flow): read_metric -merge -id current /nethome/dkhalil8/InnovateECE/PhysicalDesign/design/flow.metrics.d/syn_generic -previous 
#@ (flow_step:block_start)  2:   apply {{} {
#@                           :     set db [get_db flow_starting_db]
#@                           :     set flow [lindex [get_db flow_hier_path] end]
#@                           :     set setup_views [get_feature -obj $flow setup_views]
...
#@ (run_flow): pop_snapshot_stack
#@ (run_flow): push_snapshot_stack
#@ (flow_step:read_hdl) 2:   set hdl_file_list [list ../pipeline_src/core_pkg.sv  ../pipeline_src/ALU.sv  ../pipeline_src/DFlipFlop.sv  ../pipeline_src/DRAM.sv  ../pipeline_src/Register_File.sv  ../pipeline_src/Instr_Mem.sv  ../pipeline_src/Stall_Control.sv  ../pipeline_src/Flush_Control.sv  ../pipeline_src/FWD_Control.sv  ../pipeline_src/IF_Stage.sv  ../pipeline_src/ID_Stage.sv  ../pipeline_src/EX_Stage.sv  ../pipeline_src/Mem_Stage.sv  ../pipeline_src/WB_Stage.sv  ../pipeline_src/Fetch.sv  ../pipeline_src/Core.sv  ]
...
#@ (run_flow): pop_snapshot_stack
#@ (run_flow): write_db -all_root_attributes -to_file /nethome/dkhalil8/InnovateECE/PhysicalDesign/design/dbs/syn_generic.init_design.run_init_design.db
...
#@                            :   }}
#@ (run_flow): pop_snapshot_stack
#@ (run_flow): write_db -all_root_attributes -to_file /nethome/dkhalil8/InnovateECE/PhysicalDesign/design/dbs/syn_generic.db
#@ (run_flow): push_snapshot_stack
