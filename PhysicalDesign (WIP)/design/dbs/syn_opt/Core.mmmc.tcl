...
create_library_set -name ff_v1.98_0C \
    -timing { /nethome/dkhalil8/InnovateECE/PhysicalDesign/SiliconJackets/cadence_sky130/sky130_scl_9T_0.0.5/lib/sky130_ff_1.98_0_nldm.lib }
create_library_set -name ss_v1.62_125C \
    -timing { /nethome/dkhalil8/InnovateECE/PhysicalDesign/SiliconJackets/cadence_sky130/sky130_scl_9T_0.0.5/lib/sky130_ss_1.62_125_nldm.lib }
create_library_set -name tt_v1.8_25C \
    -timing { /nethome/dkhalil8/InnovateECE/PhysicalDesign/SiliconJackets/cadence_sky130/sky130_scl_9T_0.0.5/lib/sky130_tt_1.8_25_nldm.lib \
              /nethome/dkhalil8/InnovateECE/PhysicalDesign/SiliconJackets/sram_sky130/lib/sky130_sram_2kbyte_1rw1r_32x512_8_TT_1p8V_25C.lib }
...
create_rc_corner -name Nominal_25C \
    -temperature 25.0 \
    -qrc_tech /nethome/dkhalil8/InnovateECE/PhysicalDesign/design/../SiliconJackets/cadence_sky130/sky130_release_0.0.4/quantus/extraction/typical/qrcTechFile \
    -pre_route_res 1.0 \
    -pre_route_cap 1.0 \
...
create_constraint_mode -name func \
    -sdc_files { /nethome/dkhalil8/InnovateECE/PhysicalDesign/design/dbs/syn_opt/Core.func.sdc }
