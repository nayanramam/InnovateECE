...
create_flow_step -name read_hdl -owner design {
  ...
  ../pipeline_src/include/core_pkg.sv \
  ../pipeline_src/DFlipFlop.sv \
  ../pipeline_src/DRAM.sv \
  ../pipeline_src/ALU.sv \
  ../pipeline_src/Instr_Mem.sv \
  ../pipeline_src/Register_File.sv \
  ../pipeline_src/Flush_Control.sv \
  ../pipeline_src/FWD_Control.sv \
  ../pipeline_src/Stall_Control.sv \
  ../pipeline_src/module_loadstore_unit.sv \
  ../pipeline_src/IF_Stage.sv \
  ../pipeline_src/ID_Stage.sv \
  ../pipeline_src/EX_Stage.sv \
  ../pipeline_src/Mem_Stage.sv \
  ../pipeline_src/WB_Stage.sv \
  ../pipeline_src/Fetch.sv \
  ../pipeline_src/Core.sv \
]
