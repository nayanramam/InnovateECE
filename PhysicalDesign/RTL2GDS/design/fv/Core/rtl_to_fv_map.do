...
# Generated on: Tue Mar 17 19:52:31 EDT 2026 (Tue Mar 17 23:52:31 UTC 2026)
...
read_implementation_information fv/Core -revised fv_map -use_rtl_names
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 ../pipeline_src/include/core_pkg.sv ../pipeline_src/DFlipFlop.sv ../pipeline_src/DRAM.sv ../pipeline_src/ALU.sv ../pipeline_src/Instr_Mem.sv ../pipeline_src/Register_File.sv ../pipeline_src/Flush_Control.sv ../pipeline_src/FWD_Control.sv ../pipeline_src/Stall_Control.sv ../pipeline_src/IF_Stage.sv ../pipeline_src/ID_Stage.sv ../pipeline_src/EX_Stage.sv ../pipeline_src/Mem_Stage.sv ../pipeline_src/WB_Stage.sv ../pipeline_src/Fetch.sv ../pipeline_src/Core.sv
...
set_analyze_option -mapping_file fv/Core/fv_map.map.do
