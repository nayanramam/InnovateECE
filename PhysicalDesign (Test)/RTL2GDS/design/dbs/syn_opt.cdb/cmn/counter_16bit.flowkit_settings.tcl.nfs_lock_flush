...
## Written on 13:31:26 13-Mar 2026
#############################################################
#####   Flow Definitions   ##################################
...
create_flow_step -name read_hdl -start_steps {} -end_steps {} -owner design {
  set hdl_file_list [list ../pipeline_src/test.sv]
  read_hdl -sv $hdl_file_list
  elaborate counter_16bit
}
...
if {[is_attribute flow_caller_data -obj_type root]} {set_db flow_caller_data {group 0 process_branch 0 trunk_process 1 flowtool_hostname ece-rschsrv.ece.gatech.edu flowtool_pid 2146887}}
if {[is_attribute flow_metrics_snapshot_uuid -obj_type root]} {set_db flow_metrics_snapshot_uuid 627eb65e-3a46-4866-b591-9a0c504f1556}
if {[is_attribute flow_starting_db -obj_type root]} {set_db flow_starting_db {rc dbs/syn_map.db counter_16bit {}}}
