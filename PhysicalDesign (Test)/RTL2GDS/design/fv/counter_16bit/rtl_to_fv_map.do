...
# Generated on: Fri Mar 13 13:29:49 EDT 2026 (Fri Mar 13 17:29:49 UTC 2026)
...
set logfile fv/counter_16bit/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/counter_16bit -revised fv_map -use_rtl_names
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 ../pipeline_src/test.sv
elaborate_design -golden -root {counter_16bit} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/counter_16bit/fv_map.v.gz
elaborate_design -revised -root {counter_16bit}
...
set_analyze_option -mapping_file fv/counter_16bit/fv_map.map.do
...
write_compared_points noneq.compared_points.counter_16bit.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.counter_16bit.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.counter_16bit.rtl.fv_map.rpt
