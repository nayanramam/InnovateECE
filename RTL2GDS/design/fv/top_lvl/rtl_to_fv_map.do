...
# Generated on: Thu Oct 09 16:09:25 EDT 2025 (Thu Oct 09 20:09:25 UTC 2025)
...
set logfile fv/top_lvl/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/top_lvl -revised fv_map -use_rtl_names
...
set env(CDN_SYNTH_ROOT) "/tools/software/cadence/ddi/latest/GENUS251/tools.lnx86"
set CDN_SYNTH_ROOT      "/tools/software/cadence/ddi/latest/GENUS251/tools.lnx86"
set env(CW_DIR) "/tools/software/cadence/ddi/latest/GENUS251/tools.lnx86/lib/chipware"
set CW_DIR      "/tools/software/cadence/ddi/latest/GENUS251/tools.lnx86/lib/chipware"
set lec_version_required "21.20249"
if { ($lec_version < $lec_version_required) &&
    [file exists /tools/software/cadence/ddi/latest/GENUS251/tools.lnx86/lib/chipware/old_encrypt_sim]} {
    set env(CW_DIR_SIM) "/tools/software/cadence/ddi/latest/GENUS251/tools.lnx86/lib/chipware/old_encrypt_sim"
    set CW_DIR_SIM      "/tools/software/cadence/ddi/latest/GENUS251/tools.lnx86/lib/chipware/old_encrypt_sim"
} else {
    set env(CW_DIR_SIM) "/tools/software/cadence/ddi/latest/GENUS251/tools.lnx86/lib/chipware/sim"
    set CW_DIR_SIM      "/tools/software/cadence/ddi/latest/GENUS251/tools.lnx86/lib/chipware/sim"
}
...
add_notranslate_modules -library -both sky130_sram_2kbyte_1rw1r_32x512_8
# ILM modules: 

add_search_path . /tools/software/cadence/ddi/latest/GENUS251/tools.lnx86/lib/tech -library -both
read_library -liberty -both \
    /nethome/dkhalil8/Physical-Design-Onboarding/RTL2GDS/SiliconJackets/cadence_sky130/sky130_scl_9T_0.0.5/lib/sky130_tt_1.8_25_nldm.lib \
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 ../pipeline_src/calculator_pkg.sv ../pipeline_src/full_adder.sv ../pipeline_src/adder32.sv ../pipeline_src/result_buffer.sv ../pipeline_src/controller.sv ../pipeline_src/top_lvl.sv
elaborate_design -golden -root {top_lvl} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/top_lvl/fv_map.v.gz
elaborate_design -revised -root {top_lvl}
...
set_analyze_option -mapping_file fv/top_lvl/fv_map.map.do
...
set_system_mode lec
write_compared_points noneq.compared_points.top_lvl.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.top_lvl.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.top_lvl.rtl.fv_map.rpt
