...
## Written on 16:11:41 09-Oct 2025
#############################################################
#####   Flow Definitions   ##################################
...
if {[is_attribute flow_caller_data -obj_type root]} {set_db flow_caller_data {group 0 process_branch 0 trunk_process 1 flowtool_hostname ece-rschsrv.ece.gatech.edu flowtool_pid 3151469}}
if {[is_attribute flow_metrics_snapshot_uuid -obj_type root]} {set_db flow_metrics_snapshot_uuid 3dbd4414-5cfc-4297-81f9-17b10bdf6836}
if {[is_attribute flow_starting_db -obj_type root]} {set_db flow_starting_db {rc dbs/syn_map.db_1 top_lvl {}}}
