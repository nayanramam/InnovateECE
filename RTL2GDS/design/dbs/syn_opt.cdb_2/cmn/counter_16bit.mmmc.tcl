#################################################################################
#
# Created by Genus(TM) Synthesis Solution 25.11-s095_1 on Mon Feb 09 13:50:17 EST 2026
#
#################################################################################

## library_sets
create_library_set -name ff_v1.98_0C \
    -timing { /nethome/dkhalil8/InnovateECE/RTL2GDS/SiliconJackets/cadence_sky130/sky130_scl_9T_0.0.5/lib/sky130_ff_1.98_0_nldm.lib }
create_library_set -name ss_v1.62_125C \
    -timing { /nethome/dkhalil8/InnovateECE/RTL2GDS/SiliconJackets/cadence_sky130/sky130_scl_9T_0.0.5/lib/sky130_ss_1.62_125_nldm.lib }
create_library_set -name tt_v1.8_25C \
    -timing { /nethome/dkhalil8/InnovateECE/RTL2GDS/SiliconJackets/cadence_sky130/sky130_scl_9T_0.0.5/lib/sky130_tt_1.8_25_nldm.lib \
...
create_rc_corner -name Nominal_25C \
    -temperature 25.0 \
    -qrc_tech /nethome/dkhalil8/InnovateECE/RTL2GDS/design/../SiliconJackets/cadence_sky130/sky130_release_0.0.4/quantus/extraction/typical/qrcTechFile \
    -pre_route_res 1.0 \
    -pre_route_cap 1.0 \
...
create_constraint_mode -name func \
    -sdc_files { /nethome/dkhalil8/InnovateECE/RTL2GDS/design/dbs/syn_opt.cdb_2/cmn/counter_16bit.mmmc/modes/func/func.sdc.gz }

## analysis_view
create_analysis_view -name tt_v1.8_25C_Nominal_25_func \
    -constraint_mode func \
    -delay_corner tt_v1.8_25C_Nominal_25 \
    -latency_file /nethome/dkhalil8/InnovateECE/RTL2GDS/design/dbs/syn_opt.cdb_2/cmn/counter_16bit.mmmc/views/tt_v1.8_25C_Nominal_25_func/latency.sdc.gz
